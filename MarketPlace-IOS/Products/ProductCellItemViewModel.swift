...
class ProductCellItemViewModel: ObservableObject {
    ...
    func editProduct() {
        if let selectedCategory = selectedCategory {
            let ediProduct = EditProduct(product_id: product.product_id, product_name: product.product_name, description: product.description, price: product.price, stock: product.stock,  imageids: product.imageids ?? [], isPublish: true,
